...
export const JWT_PASSWORD = process.env.JWT_PASSWORD || "chat_bees";

export const REDIS_SERVICE_URL = process.env.REDIS_SERVICE_URL;
...
export const CHAT_BEES_USER = process.env.CHAT_BEES_USER;
export const CHAT_BEES_USER_PASSWORD = process.env.CHAT_BEES_USER_PASSWORD;
